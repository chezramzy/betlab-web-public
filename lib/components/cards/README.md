...
**Import:**
```typescript
import { MatchCard, MatchCardCompact } from "@/lib/components/cards"
```
...
**Import:**
```typescript
import { MatchCardSkeleton, MatchCardSkeletonCompact } from "@/lib/components/cards"
```
...
**Import:**
```typescript
import { PredictionCard } from "@/lib/components/cards"
```
...
```tsx
import { Over15Card } from "@/lib/components/cards"
...
```tsx
import { BTTSCard } from "@/lib/components/cards"
...
```tsx
import { ExactScoreCard } from "@/lib/components/cards"
...
```tsx
import { HTFTCard } from "@/lib/components/cards"
...
```tsx
import { HalfCompareCard } from "@/lib/components/cards"
...
```tsx
import { CleanSheetCard } from "@/lib/components/cards"
...
```tsx
import { CornersCard } from "@/lib/components/cards"
...
```tsx
import { InternalProbabilitiesCard } from "@/lib/components/cards"
...
```tsx
import { ConfidenceBadge } from "@/lib/components/common"
...
```tsx
import { EdgeChip } from "@/lib/components/common"
...
```tsx
import { LiveBadge } from "@/lib/components/common"
