...
//   () => import('@/shared/ui/legacy/match-detail/analysis-tab').then(mod => ({ default: mod.AnalysisTab })),
//   {
...
//   () => import('@/shared/ui/legacy/match-detail/h2h-tab').then(mod => ({ default: mod.H2HTab })),
//   {
...
//   () => import('@/shared/ui/legacy/match-detail/stats-tab').then(mod => ({ default: mod.StatsTab })),
//   {
